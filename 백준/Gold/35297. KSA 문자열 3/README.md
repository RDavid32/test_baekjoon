# [Gold II] KSA 문자열 3 - 35297 

[문제 링크](https://www.acmicpc.net/problem/35297) 
...
2026년 2월 21일 21:50:21

### 문제 설명

<p>KSAAC 운영진은 모두 KSA를 사랑하기 때문에 다음 조건을 만족하는 문자열을 좋아한다.</p>
...
<p>문자열에는 다음 시행을 $0$회 이상 할 수 있으며 매회 둘 중 하나를 선택하여 시행할 수 있다.</p>

<ul>
<li>존재하는 문자들 중 인접한 문자 2개를 제거한다.</li>
<li>문자열의 맨 앞에 동일한 문자를 2개 추가한다.</li>
</ul>
...
<p>주어진 시행을 유한 번 하는 것으로 문자열 $X$를 $X$와 길이가 같으면서 KSAAC 운영진이 좋아하는 문자열로 바꿀 수 있음이 보장된다.</p>
